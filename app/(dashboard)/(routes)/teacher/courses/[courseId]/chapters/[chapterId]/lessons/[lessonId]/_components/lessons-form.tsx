...
export const LessonsForm = ({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.post(`/api/courses/${initialData.courseId}/chapters/${chapterId}/lessons`, values);
  ...
  const onReorder = async (updateData: { id: string; position: number }[]) => {
    try {
      ...
      await axios.put(`/api/courses/${chapterId}/chapters/reorder`, {
        list: updateData
      });
  ...
  const onEdit = (id: string) => {
    router.push(`/teacher/courses/${initialData.courseId}/chapters/${chapterId}/lessons/${id}`);
  }
